...
sudo apt-get install -y owfs-doc
...
1,6,11,16,21,26,31,36,41,46,51,56 * * * * /home/pi/boiler_info/bin/boiler-httpd.sh >> /mnt/ramfs/1000/rpiboiler/boiler-httpd.log 2>&1
